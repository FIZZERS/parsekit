...
- (id)init {
    ...
    if (self) {
        ...
        self._tokenKindNameTab[LABELEBNF_TOKEN_KIND_EQUALS] = @"=";
        self._tokenKindNameTab[LABELEBNF_TOKEN_KIND_RETURN] = @"return";
        self._tokenKindNameTab[LABELEBNF_TOKEN_KIND_COLON] = @":";
